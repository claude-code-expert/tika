...
export function LabelChip({ name, color, onRemove, size = 'sm' }: LabelChipProps) {
  const sizeStyle =
    size === 'md'
      ? { height: 22, fontSize: 11, padding: '0 8px', borderRadius: 5, gap: 5 }
      : { height: 18, fontSize: 10, padding: '0 6px', borderRadius: 4, gap: 4 };
